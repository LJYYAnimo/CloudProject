...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        //多模块需要生成在什么模块
        String[] models = {"mapper","entity","service","web"};
    ...
    private static void shell(String model){
        ...
        strategy.setInclude(new String[] { "t_upload_space"}); // 需要生成的表
