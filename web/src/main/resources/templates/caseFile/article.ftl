    ...
    <form class="layui-form" action="" lay-filter="newsForm">
        <div class="layui-form-item layui-col-xs10 layui-col-sm12 layui-col-md11">
            ...
            <div class="layui-input-block">
                <input type="text" name="worksTitle" id="worksTitle"  disabled autocomplete="off"  class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item layui-form-text layui-col-xs10 layui-col-sm12 layui-col-md11">
            ...
            <div class="layui-input-block">
                <input type="text" name="worksType" id="worksType"  disabled autocomplete="off"  class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item layui-form-text layui-col-xs11 layui-col-sm11 layui-col-md11">
            ...
            <div class="layui-input-block">
                <input type="text" name="worksIntegral" id="worksIntegral"  disabled autocomplete="off"  class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item layui-col-xs12 layui-col-sm10 layui-col-md8">
            ...
            <div class="layui-input-block">
                <a class="layui-btn layui-btn-normal layui-btn-xs"  id="worksAddress">下载附件</a>
            </div>
        </div>
...
<script src="/js/works/article.js"></script>
</body>
</html>