    ...
    <form class="layui-form">
        <div class="layui-form-item">
            <div class="layui-inline">
                <input type="button" class="layui-btn" id="add" value="添加学校">
            </div>
            <div class="layui-inline">
                <div class="layui-input-inline">
                    <input type="text" id="schoolName" name="schoolName" autocomplete="off" class="layui-input" placeholder="输入学校名称">
                </div>
            </div>
            <div class="layui-inline">
