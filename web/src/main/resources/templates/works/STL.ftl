...
<html lang="en">
	...
	<body>
		<script src="/js/WebGLViewer/three.js"></script>
		<script src="/js/WebGLViewer/loaders/STLLoader.js"></script>
		<script src="/js/WebGLViewer/OrbitControls.js"></script>
		...
		<script>
            ...
            setTimeout(function() {
				...
				function init() {
					...
					if(value!=undefined&&value!=null&&value.stl!=''){

						loader.load(value.stl+"", function ( geometry ) {
