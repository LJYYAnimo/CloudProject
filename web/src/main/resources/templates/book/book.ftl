            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <input type="text" id="title" name="title" autocomplete="off" class="layui-input" placeholder="输入书名">
                    </div>
                </div>
                <div class="layui-inline">
                    <div class="layui-input-inline">
                ...
                <div class="layui-inline">
                    <select name="bookAudit" id="bookAudit" lay-filter="bookAudit">
    ...
    <form id="schoolType" class="layui-form">
        ...
        <div class="layui-form-item layui-col-xs10 layui-col-sm12 layui-col-md11 ">
            ...
            <div class="layui-col-xs8">
                <textarea name="bookUnreason" id="bookUnreason"  placeholder="请输入内容"  class="layui-textarea"></textarea>
            </div>
        </div>
        <div class="layui-form-item ">
...
<script type="text/html" id="urlURL">
    ...
    {{# }else{ }}
    <a class="layui-btn layui-btn-normal layui-btn-xs"   href="{{d.url}}"  alt="{{ d.url }}">下载文件</a>
    {{# } }}
</script>
...
<script type="text/html" id="type">
    ...
    {{# }else if(d.type == 1 ){ }}
    <span style="color: #74ff66;">未出版</span>
    {{# } }}
...
<script type="text/html" id="bookType">
    ...
    <span style="color: #74ff66;">收费</span>
    {{# } }}
</script>
</html>